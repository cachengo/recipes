...
def scale_predictions(predictions,img1_shape,img0_shape,ratio_pad=None):
    scaled_predictions=copy.deepcopy(predictions)
    for prediction in scaled_predictions:
        scale_coords(img1_shape, prediction, img0_shape, ratio_pad)
